...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    /**
     * 컨트롤러의 메서드의 특정 파라미터를 지원하는 지 판단.
     * 여기서는 파라미터의 @LoginUser 어노테이션이 붙어있고, 파라미터 클래스 타입이 SessionUser.class 인 경우 true
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        boolean isUserClass = SessionUser.class.equals(parameter.getParameterType()); // SessionUser 클래스인 경우 true
